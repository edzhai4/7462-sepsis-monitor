...
```{r}
library(googledrive)
drive_auth(email = "zhaix069@umn.edu")
...
most_recent_data %>% 
  ...
  kable(format = "simple",caption = "Most recent Physio. Data For Those Who Have Sepsis")
...
summ.tab %>%
  kable(format = "simple",escape = FALSE) %>%
